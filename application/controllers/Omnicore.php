...
class Omnicore extends Default_Controler
{
    ...
    {
        $this->load->view('frontend/insightDetailspage');
    }
    private function csuiteintelligence()
    {
        $this->load->view('frontend/csuiteintelligence');
    }
    private function newenergies()
    {
        $this->load->view('frontend/newenergies');
    }

    private function insightspage()
    {
        $this->load->view('frontend/insightspage');
    }
